...
public class SubGallery : MonoBehaviour,ISerializationCallbackReceiver
{

    public Sprite subGalleryAvatar;
    public string subGalleryName;
    public string subGalleryInfo;
    public Gallery gallery;
    public SubGalleryButton subGalleryButton;
